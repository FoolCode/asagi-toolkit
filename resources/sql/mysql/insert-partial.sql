...
(
	...
	spoiler, deleted, capcode, email, name, trip, title, comment, delpass, sticky, poster_hash, poster_country, exif
)
SELECT 
	...
	spoiler, deleted, capcode, email, name, trip, title, comment, delpass, sticky, NULL, NULL, NULL
